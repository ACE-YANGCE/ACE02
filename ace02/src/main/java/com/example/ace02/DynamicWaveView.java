...
/**
 * Created by ace on 2017/5/27 0027.
 */
...
public class DynamicWaveView extends View {
    ...
    public DynamicWaveView(Context context, AttributeSet attrs) {
        ...
        mXOffsetSpeedOne = BitmapUtil.dipToPx(context, TRANSLATE_X_SPEED_ONE);
        mXOffsetSpeedTwo = BitmapUtil.dipToPx(context, TRANSLATE_X_SPEED_TWO);
